create or replace 
PROCEDURE INS_APECO02_TO_ECO02  IS
...
BEGIN
   DECLARE
     V_PG_ID          	            VARCHAR2(70) := 'ins_APECO02_TO_ECO02.prc';
...
BEGIN
          ...
          V_COMMIT_FLG := '0';
  	      ...
  	      BEGIN       
              ...
              INSERT INTO SYS_ERR_01 (   
                    ...
                    VALUES (   'ECO02'
                              ,'When: ' || TO_CHAR(SYSDATE,'YYYYMMDD HH24:MI:SS') 
                              , 'Action: Inserted one into DSW_ECO02_S1 : ' || 'TRANS_ID:' || S_DB_REC_T1.TRANSACTION_ID  || 'CUSTOMS_MESSAGE_ID:' || S_DB_REC_T1.CUSTOMS_MESSAGE_ID
                              , 'Included in INS_APECO02_2_ECO02'
                            );
              ...
              INSERT INTO ACI_CSZOBBL  (  TRANS_ID
               ...
               INSERT INTO SYS_ERR_01 (   
                    ...
                    VALUES (   'ECO02'
                              ,'When: ' || TO_CHAR(SYSDATE,'YYYYMMDD HH24:MI:SS') 
                              , 'Action: Inserted one into ACI_CSZOBBL : ' || 'TRANS_ID:' || S_DB_REC_T1.TRANSACTION_ID  || 'CUSTOMS_MESSAGE_ID:' || S_DB_REC_T1.CUSTOMS_MESSAGE_ID
                              , 'Included in INS_APECO02_2_ECO02'
                            );
    ...
    INSERT INTO SYS_ERR_01 (   TNAME
                    ...
                    VALUES (   'ECO02'
                              ,'When: ' || TO_CHAR(SYSDATE,'YYYYMMDD HH24:MI:SS') 
                              , 'INS_APECO02_2_ECO02 was executed.'
                              , 'How many rows were taken care:  ' || V_S_DB_CNT_T1
                            );
